...
export function LairFloatingSidebar({ open }: { open: boolean }) {
  ...
  return (
    <motion.aside
      ...
      className="fixed right-4 top-16 bottom-12 z-40 flex w-[min(18rem,calc(100vw-2rem))] flex-col overflow-hidden rounded-lg border border-border/70 bg-card shadow-2xl ring-1 ring-black/10 dark:ring-white/10"
